...
sleep 1
wget https://raw.githubusercontent.com/basikal123/moto/main/sshws/ins-xray.sh && chmod +x ins-xray.sh && screen -S ins-xray ./ins-xray.sh
echo -e "\e[0;32mDONE INSTALLING XRAY CORE\e[0m"
clear
#install websocket
echo -e "\e[0;32mINSTALLING WEBSOCKET PORT...\e[0m"
wget https://raw.githubusercontent.com/basikal123/moto/main/sshws/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
